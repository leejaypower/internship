...
userRouter.get('/self', authMiddleware([TABLE.USER_ROLE.USER]), userController.getUserSelf);
userRouter.patch('/self', authMiddleware([TABLE.USER_ROLE.USER]), userController.updateUserSelf); // userController.updateUserSelf
userRouter.delete('/self', authMiddleware([TABLE.USER_ROLE.USER]), userController.deleteUserSelf);
